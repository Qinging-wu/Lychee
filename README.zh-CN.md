...
一个极小的 Windows 桌面悬浮球，置顶显示 CPU、内存、网速、公网 IP 和延迟。鼠标悬停展开信息面板，移开自动收起。基于 .NET 8 WPF + WinForms，无需安装、无后台服务。
...
| 版本 | 变更 | 说明 |
|---|---|---|
| v2.0.0-beta.1 | 🚨 IP 查询告警 | 改善IP模块体验 |
| v1.4.0 | ??? | 什么都没有发生 (?) |
| v1.3.0 | 🧲 吸附边缘 | 拖拽结束后悬浮球自动吸附到最近的屏幕边缘（可在设置中开关） |
